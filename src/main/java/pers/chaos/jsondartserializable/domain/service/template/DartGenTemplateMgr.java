package pers.chaos.jsondartserializable.domain.service.template;
...
public final class DartGenTemplateMgr {
    interface Header {
    ...
    public static String formatImportClass(String filename) {
        return String.format(Header.importClass, DartGenOption.FileSuffix.DART.filename(filename));
    }
